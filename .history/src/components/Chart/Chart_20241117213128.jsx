...
const useChartData = (timeframe) => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      console.log(`Data received for ${timeframe}:`, rawData);
      ...
      const formattedData = await rawData.time.map((time, i) => ({
      ...
      console.log(`Formatted ${formattedData.length} candles for ${timeframe}`);
