...
const Controls = ({ onTimeframeChange, currentTimeframe, randomDate, onAddCandle, fullDataset, onBarCountChange,currentBarCount }) => {
  ...
  return (
    <div className="controls">
      ...
      <div className="actions">
        <button onClick={randomDate} className="action-button">
          Random Point
        </button>
